...
dev_list="bison cdbs curl dpkg-dev elfutils devscripts fakeroot
          ...
          patch perl php-cgi pkg-config python python-cherrypy3 python-crypto
          python-dev python-numpy python-opencv python-openssl python-psutil
          python-yaml rpm ruby subversion ttf-dejavu-core fonts-indic
          wdiff zip
          $chromeos_dev_list"
...
new_list_cmd="sudo apt-get install $(echo $packages)"
